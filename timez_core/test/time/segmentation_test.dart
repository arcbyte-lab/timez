...
//
//   test('block exactly ending at noon: one AM segment, sweep ends at 360°, no split', () {
//     final block = _block(
...
//     expect(segments.single.startAngle + segments.single.sweepAngle, closeTo(360.0, 0.001));
//   });
//
...
//   });
//
//   test('a block spanning noon (not a window boundary) splits with interior continuation flags', () {
//     final block = _block(
//       startUtc: DateTime.utc(2026, 3, 10, 3, 0),  // 10:00 local
...
//   });
//
//   test('a block spanning midnight produces correct segments on both adjacent days', () {
//     final block = _block(
//       id: 'midnight-block',
...
//     expect(day2.single.continuesFromPrevious, isTrue);     // clipped at window start
...
//     expect(
//       [day1.single.continuesFromPrevious, day1.single.continuesToNext,
//        day2.single.continuesFromPrevious, day2.single.continuesToNext],
