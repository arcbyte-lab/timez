...
void main() {
  group('deriveColor', () {
    ...
    test(
      'a single attached tag is always primary regardless of sortOrder value',
      () {
  ...
  group('needsContrastOutline', () {
    test(
      'low-contrast tag color against a light background needs an outline',
      () {
    ...
    test(
      'high-contrast tag color against a light background needs no outline',
      () {
